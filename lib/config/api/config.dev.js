...
module.exports = {
  ...
  sync : {
    harvest_vehicles : "http://dev.emos.productplacement.corbis.pre/index.php?layout=vehicles",
    vehicle : "http://dev.emos.productplacement.corbis.pre/index.php?layout=vehicles&id=%s"
  },
...
//            "type": "console"
            "type": "file",
            "absolute" : true,
            "filename": "C:/Logs/ben_api/sync.log",
            "maxLogSize": 1 * 1024 * 1024 * 1024, // 1mb
            "backups": 10,
            "pollInterval": 15
          }
